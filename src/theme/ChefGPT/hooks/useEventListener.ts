/** @see https://github.com/magento/pwa-studio/blob/52229b26a01e61c574069b2994991c04e0796650/packages/peregrine/lib/hooks/useEventListener.js */
 ...
 */
export const useEventListener = (target: EventTarget, type: string, listener: EventListenerOrEventListenerObject, ...rest: any) => {
  useEffect(() => {
