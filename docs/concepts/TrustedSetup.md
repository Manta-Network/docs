...
1. **Clone Repository**: Clone this repository with 
```sh
git clone https://github.com/Manta-Network/manta-rs.git
```
Note that this will create a copy of the repository in your current directory.

2. **Build Client**: ? To Do: Do they have to do anything before running the bins?? Don't think so...
...
TODO: What can be said about anonymity and registration? 
