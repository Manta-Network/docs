...
See [here](../guides/TrustedSetup.md) for participation instructions. Read on to learn about trusted setups in general and the role they play on Manta Network.
...
We have written software that will allow you to participate honestly without having to understand the mathematical details of the ceremony.  The detailed instructions for using this software [here](../guides/TrustedSetup.md).  The basic steps are
...
If you want to help ensure the security of Manta Network then follow [these instructions](../guides/TrustedSetup.md).