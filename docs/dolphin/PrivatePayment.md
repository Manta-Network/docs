...
[![Tech Talk #1](assets/tech-talk-1-thumbnail.jpg)](https://www.youtube.com/watch?v=qmRChiIDl2A)

You can follow along with [this video](https://www.youtube.com/watch?v=qmRChiIDl2A), [download the slides](assets/tech-talk-1-slides.pdf), and/or keep reading below to get an overview and some technical details about how _Private Payment_ works.
...
![Send Protocol](assets/send-protocol.png)
...
![Receive Protocol](assets/receive-protocol.png)
...
![Encryption (Full)](assets/encryption-full.png)
...
![Decryption (Full)](assets/decryption-full.png)
...
![Ownership Certificates](assets/utxo-explanation.png)
...
![Receiver UTXO](assets/utxo-construction.png)
...
![Sender UTXO and Void Number](assets/void-number-construction.png)
...
![ZKP Details](assets/zkp-details.png)
...
![Generalized Protocol](assets/generalized-protocol.png)
