...
:::caution Atlantic may not accept new staking

Manta Atlantic is **winding down** (parachain slot ~**late July–early August 2026**). **New staking** may already be or may soon become **disabled**, and **rewards** may end on dates in the **Manta Atlantic Deprecation FAQ** (summary **March 18, 2026**; phased details through **May 1, 2026**). If you are learning delegation for the first time on Atlantic, read the [Staking overview](../01-Overview) and use the **Migration DApp** when available instead of opening new positions.
