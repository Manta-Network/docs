...
SubQuery is a leading blockchain data indexer that provides developers with fast, flexible, universal, open source and decentralised APIs for web3 projects. SubQuery SDK allows developers to get rich indexed data and build intuitive and immersive decentralised applications in a faster and more efficient way. SubQuery supports 100+ ecosystems including Manta Pacific, Manta Atlantic, Ethereum, Near, Polygon, Polkadot, Algorand, and Avalanche.
...
- [Manta Pacific Starter Project](https://github.com/subquery/ethereum-subql-starter/tree/main/Manta/manta-pacific-starter)
- For technical questions and support reach out to us `start@subquery.network`

## Running and Hosting your Manta Pacific SubQuery APIs
